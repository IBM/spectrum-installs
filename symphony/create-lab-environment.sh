...
createConsumer /$LAB_USER $LAB_EXEC_USER $RG_COMPUTE_NAME $RG_MANAGEMENT_NAME $LAB_USER
createConsumer /$LAB_USER/$LAB_USER-app1 $LAB_EXEC_USER $RG_COMPUTE_NAME $RG_MANAGEMENT_NAME $LAB_USER
createConsumer /$LAB_USER/$LAB_USER-app2 $LAB_EXEC_USER $RG_COMPUTE_NAME $RG_MANAGEMENT_NAME $LAB_USER
